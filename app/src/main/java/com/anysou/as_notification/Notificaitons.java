...
public class Notificaitons {
    ...
    public final static String ACTION_SIMPLE = "com.anysou.as_notification.ACTION_SIMPLE";
    public final static String ACTION_ACTION = "com.anysou.as_notification.ACTION_ACTION";
    public final static String ACTION_REMOTE_INPUT = "com.anysou.as_notification.ACTION_REMOTE_INPUT";
    public final static String ACTION_BIG_PICTURE_STYLE = "com.anysou.as_notification.ACTION_BIG_PICTURE_STYLE";
    public final static String ACTION_BIG_TEXT_STYLE = "com.anysou.as_notification.ACTION_BIG_TEXT_STYLE";
    public final static String ACTION_INBOX_STYLE = "com.anysou.as_notification.ACTION_INBOX_STYLE";
    public final static String ACTION_MEDIA_STYLE = "com.anysou.as_notification.ACTION_MEDIA_STYLE";
    public final static String ACTION_MESSAGING_STYLE = "com.anysou.as_notification.ACTION_MESSAGING_STYLE";
    public final static String ACTION_PROGRESS = "com.anysou.as_notification.ACTION_PROGRESS";
    public final static String ACTION_CUSTOM_HEADS_UP_VIEW = "com.anysou.as_notification.ACTION_CUSTOM_HEADS_UP_VIEW";
    public final static String ACTION_CUSTOM_VIEW = "com.anysou.as_notification.ACTION_CUSTOM_VIEW";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LOVE = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_LOVE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PRE = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_PRE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_NEXT = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_NEXT";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LYRICS = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_LYRICS";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_CANCEL = "com.anysou.as_notification.ACTION_CUSTOM_VIEW_OPTIONS_CANCEL";

    public final static String ACTION_YES = "com.anysou.as_notification.ACTION_YES";
    public final static String ACTION_NO = "com.anysou.as_notification.ACTION_NO";
    public final static String ACTION_DELETE = "com.anysou.as_notification.ACTION_DELETE";
    public final static String ACTION_REPLY = "com.anysou.as_notification.ACTION_REPLY";
    ...
    public void sendRemoteInputNotification(Context context, NotificationManager nm) {
        ...
        Notification.Builder nb = new Notification.Builder(context,NotificationChannels.IMPORTANCE)
                ...
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
                .setContentTitle("回复功能通知")
                //设置通知内容
                .setContentText("带快速回复功能通知 !")
                //设置点击通知后自动删除通知
                .setAutoCancel(true)
                //设置显示通知时间
                .setShowWhen(true)
    ...
    public void sendBigPictureStyleNotification(Context context, NotificationManager nm) {
        ...
        Notification.BigPictureStyle bigPictureStyle = new Notification.BigPictureStyle()
                .setBigContentTitle("大图效果通知")
                .setSummaryText("这是一个大图效果通知！")
        ...
        Notification.Builder nb = new Notification.Builder(context,NotificationChannels.DEFAULT)
                ...
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
                .setContentTitle("大图效果")
                //设置通知内容
                .setContentText("这是一个大图效果！")
                //设置点击通知后自动删除通知
                .setAutoCancel(true)
                //设置显示通知时间
                .setShowWhen(true)
    ...
    public void sendBigTextStyleNotification(Context context, NotificationManager nm) {
        ...
        Notification.Builder nb = new Notification.Builder(context,NotificationChannels.DEFAULT)
                ...
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
                .setContentTitle("多文字效果")
                //设置通知内容
                .setContentText("多文字效果 !")
                //设置点击通知后自动删除通知
                .setAutoCancel(true)
                //设置显示通知时间
                .setShowWhen(true)
    ...
    public void sendInboxStyleNotification(Context context, NotificationManager nm) {
        ...
        Notification.InboxStyle inboxStyle = new Notification.InboxStyle()
                .setBigContentTitle("信箱效果通知")
                .setSummaryText("这是一个信箱效果通知")
                //最多六行
        ...
        Notification.Builder nb = new Notification.Builder(context,NotificationChannels.DEFAULT)
                ...
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
                .setContentTitle("信箱效果")
                //设置通知内容
                .setContentText("这是一个信箱效果 !")
                //设置点击通知后自动删除通知
                .setAutoCancel(true)
                //设置显示通知时间
                .setShowWhen(true)
    ...
    public void sendMessagingStyleNotification(Context context, NotificationManager nm) {
        ...
        Notification.Builder nb = new Notification.Builder(context,NotificationChannels.DEFAULT)
                ...
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
                .setContentTitle("信息效果")
                //设置通知内容
                .setContentText("这是信息效果 !")
                //设置点击通知后自动删除通知
                .setAutoCancel(true)
                //设置显示通知时间
                .setShowWhen(true)
